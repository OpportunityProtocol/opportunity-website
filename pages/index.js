        ...
        <main className={styles.main}>
              ...
              >
                ...
                >
                  <div className={classes.introductionTextContainer}>
                    ...
                    <Typography width="50%" variant="body1" fontSize={15} color="#8f8f8f">
                      {bodyText}
                    </Typography>
          ...
          <section className={classes.section}>
            ...
            >
              ...
              >
                <Grid xs={12} md={12} lg={6} item style={{ width: '100%' }}>
                  <Card elevation={0} style={{ width: '100%', height: '100%' }}>
                    <img src="/girl.jpeg" style={{ width: '100%', height: 400 }} />
                  </Card>
                </Grid>
                ...
                >
                  ...
                  >
                    ...
                    permissionless so you don't have to worry about your geographical location or
                    class status.
                  </Typography>
                </Grid>
              </Grid>
              ...
              >
                <Grid xs={12} md={12} lg={6} item style={{ width: '100%' }}>
                  <Card elevation={0} style={{ width: '100%', height: '100%' }}>
                    <img src="/guy.jpeg" style={{ width: '100%', height: 400 }} />
                  </Card>
                </Grid>
                ...
                <Grid xs={12} md={12} lg={6} item>
                  ...
                  <Typography
                    ...
                    lineHeight={1.5}
                  >
                    Find work amongst your peers on a global stage. No corporations or third parties
                    involved so you keep most of your earnings.
                  </Typography>
                </Grid>
              </Grid>
              {/* end second */}
          ...
          <section style={{ backgroundColor: '#fbfbfd' }} className={classes.section}>
            ...
            >
              ...
              <Grid xs={12} sm={12} md={12} lg={6} item className={classes.fullGrid} style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', justifyContent: 'flex-end'}}>
          ...
          >
            <Typography width="80%" variant='h4' py={2} color="#212121">
              A modular application focused on doing one thing and letting the ecosystem do the rest
            </Typography>
            <Grid wrap={false} spacing={2} container direction="row" justifyContent="space-evenly">
                ...
                >
                  <Card elevation={0} className={classes.modularSectionCard}>
                    <CardContent className={classes.modularSectionCardContent}>
                      ...
                      <div>
                        <Typography width="90%" height={80} fontWeight="300" fontSize={25}>
                          Global access to markets on Opportunity
                        </Typography>

                        <Typography py={3} fontWeight="light" noWrap={false}>
                          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam eu justo
                          et tortor tempus pulvinar.
                        </Typography>
                      </div>
                    </CardContent>
              ...
              <Grid xs={12} md={12} lg={4} style={{ height: '100%' }} item>
                <Slide
                  ...
                  container={modularSectionRef.current}
                >
                  <Card elevation={0} variation="outlined" className={classes.modularSectionCard}>
                    <CardContent className={classes.modularSectionCardContent}>
                      <img src="/exchange.png" className={classes.icon} style={{ width: '40px' }} />
